/**
 * CommonJS version of questionnaire API - for hosting compatibility with prefix support
...
/**
 * Setup questionnaire routes with optional prefix
 */
function setupQuestionnaireRoutes(app, prefix = '') {
  // Send SMS verification code
  app.post(`${prefix}/api/questionnaire/send-code`, (req, res) => {
    try {
